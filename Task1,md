## @About
Young plasma developer decided to make a plasma contract. He wants to be to the first one who will launch plasma token to the moon.

As a first step, he needs to sign a contract with a first real customer that wants to see that plasma can supports ERC223 tokens.

He works on the demo, but probably his implementation that listed below has a vulnerability. Help him to find it.
